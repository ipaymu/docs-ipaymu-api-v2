...
app.post('/callback', (req, res) => {
    const secretKey = 'YOUR_VA_NUMBER_HERE'; // Nomor VA akun iPaymu Anda (lihat di Dashboard > Integration > API Key)
...
$secretKey = 'YOUR_VA_NUMBER_HERE'; // Nomor VA akun iPaymu Anda (lihat di Dashboard > Integration > API Key)
...
const SECRET_KEY: &str = "YOUR_VA_NUMBER_HERE"; // Nomor VA akun iPaymu Anda (lihat di Dashboard > Integration > API Key)
...
SECRET_KEY = 'YOUR_VA_NUMBER_HERE'  # Nomor VA akun iPaymu Anda (lihat di Dashboard > Integration > API Key)
