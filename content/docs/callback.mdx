...
postman: https://documenter.getpostman.com/view/40296808/2sB3WtseBT?version=latest#473eae42-0c4c-49ea-af0f-3c8436fcacbd
---
...
**Contoh Secret Key:** `YOUR_IPAYMU_VA`

> [!IMPORTANT]
> Jangan pernah membagikan atau mengunggah Nomor VA (Secret Key), API Key, atau kredensial merchant Anda ke repositori publik. Gunakan environment variables (`process.env.IPAYMU_VA`) atau secret manager.
...
<Tabs defaultValue="js" groupId="language">
  ...
  <TabsContent value="js" className="p-0">
    <Tabs defaultValue="urlencoded">
      <TabsList>
        <TabsTrigger value="urlencoded">x-www-form-urlencoded</TabsTrigger>
        <TabsTrigger value="json">application/json</TabsTrigger>
      </TabsList>

      <TabsContent value="urlencoded">
...
```
  ...
  <TabsContent value="php" className="p-0">
    <Tabs defaultValue="urlencoded">
      <TabsList>
        <TabsTrigger value="urlencoded">x-www-form-urlencoded</TabsTrigger>
        <TabsTrigger value="json">application/json</TabsTrigger>
...
```
  ...
  <TabsContent value="go" className="p-0">
    <Tabs defaultValue="urlencoded">
      <TabsList>
        <TabsTrigger value="urlencoded">x-www-form-urlencoded</TabsTrigger>
        <TabsTrigger value="json">application/json</TabsTrigger>
...
```
  ...
  <TabsContent value="rust" className="p-0">
    <Tabs defaultValue="urlencoded">
      <TabsList>
        <TabsTrigger value="urlencoded">x-www-form-urlencoded</TabsTrigger>
        <TabsTrigger value="json">application/json</TabsTrigger>
...
type HmacSha256 = Hmac<Sha256>;
const SECRET_KEY: &str = "YOUR_IPAYMU_VA";
