...
**Example Secret Key:** `YOUR_IPAYMU_VA`

> [!IMPORTANT]
> Never commit your production VA, API key, or other merchant credentials to a public repository. Use environment variables or a secret manager.
