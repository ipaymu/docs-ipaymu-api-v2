...
app.post('/callback', (req, res) => {
    const secretKey = 'YOUR_VA_NUMBER_HERE'; // Your iPaymu account VA Number (see Dashboard > Integration > API Key)
...
$secretKey = 'YOUR_VA_NUMBER_HERE'; // Your iPaymu account VA Number (see Dashboard > Integration > API Key)
...
const SECRET_KEY: &str = "YOUR_VA_NUMBER_HERE"; // Your iPaymu account VA Number (see Dashboard > Integration > API Key)
...
SECRET_KEY = 'YOUR_VA_NUMBER_HERE'  # Your iPaymu account VA Number (see Dashboard > Integration > API Key)
