...
<DanaNoticeCallout lang="en" />

<Callout type="warn" title="Production Requirement">
  In Production mode, ensure your server uses a **Static IP** and your domain is registered. See [IP & Domain Validation](../ip-domain-validation).
</Callout>

This endpoint is used to process direct payments.

<DirectPaymentFlowchart lang="en" />
